...
rho_f = 1100; %[kg/m^3] density of fluid, this value is set for Great Salt Lake
R = (rho_s - rho_f)/rho_f;
g = 9.8; %[m/s^2]
nu = 1.18*10^-6; %kinematic viscosity of fluid, this value is set for Great Salt Lake

young = 144*10^9; %[Pa] young's modulus
strength = 1*10^6; %[Pa] tensile strength
kv = 400*10^4; %[dimensionless] see Trower et al. (2017) for explanation
tauc = 0.03; %Critical Shields number.  0.03 is good for sand.
Stc = 1; %critical Stokes number, see Trower et al. (2017) for explanation
